            ...
            <section class="bg-white">
              ...
              <div class="p-3">
                <div class="row">
                    ...
                    $blogger_set = find_all_bloggers(['start' =>$start_from,'step'=> $num_rec_per_page] );
                    while($blogger = mysqli_fetch_assoc($blogger_set)) {
                        ...
                        <div class="col-md-6">
                            <div class="card border-0">
                               ...
                               <img class="card-img-top" src="adminpanel/img/bloggers/<?php echo htmlspecialchars(urlencode($blogger['img'])); ?>" height="300px"
                                             alt="placeholder">
                                    </a>
                                </div>
                                <div class="card-body">
                                    <h4 class="card-title news__title">
                                        <a href="single-article.php?id=<?php echo htmlspecialchars(urlencode($blogger['blogger_id'])); ?>"><?php echo htmlspecialchars($blogger['title']); ?>
                                        </a>
                                    </h4>
                                    <p class="card-text">
                        ...
                        <div class="pagination-container d-flex justify-content-center">
                            <nav aria-label="Page navigation example">
                                <ul class="pagination">
                                    <?php
                                    $blogger_set = find_all_bloggers(['start' =>$start_from,'step'=> $num_rec_per_page] );
                                    $total_records = mysqli_num_rows($blogger_set);  //count number of records
